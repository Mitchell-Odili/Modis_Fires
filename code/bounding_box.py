...
# from modis_Fire import temp_select_country
# x = temp_select_country[0]
# Iso codes dictiionary
...
iso_codes = {
  ...
  "AM": ["Austria", [43.58, 38.74, 46.51, 41.25]],
...
country_bb_codes = iso_codes_df.T.rename(columns = {0 : 'Country', 1 : 'Bounding_Box'})
country_bb_codes

# Define a function
def get_bounding_box(Country):
  if Country in country_bb_codes['Country'].values:
    west = country_bb_codes.loc[country_bb_codes.Country == Country]['Bounding_Box'][0][0]
    south = country_bb_codes.loc[country_bb_codes.Country == Country]['Bounding_Box'][0][1]
    east = country_bb_codes.loc[country_bb_codes.Country == Country]['Bounding_Box'][0][2]
    north = country_bb_codes.loc[country_bb_codes.Country == Country]['Bounding_Box'][0][3]
    return west, south, east, north

long_min, lat_min, long_max, lat_max = get_bounding_box(x)

print(x + ' Co-ordinates:', long_min, lat_min, long_max, lat_max)
